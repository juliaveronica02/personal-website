                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            ...
                            <div className="resume-item pb-0">
                                ...
                                <p>
                                    <em>Innovative and deadline-driven C# programming Language with 4 month of experience
                                        programming and developing user-centered with game using unity.</em>
                                </p>
                                <p></p>
                                <ul>
                            ...
                            <div className="resume-item">
                                <h4>Vocational High School Maitreyawira Batam &amp; Multimedia</h4>
                                <h5>2016 - 2019</h5>
                                <p>
                                    <em>Batam, Kepulauan Riau</em>
                                </p>
                                <p>learn about C programming, C# programming when internship</p>
                            </div>
                            <div className="resume-item">
